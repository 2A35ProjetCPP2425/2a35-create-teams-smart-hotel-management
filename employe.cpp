...
#include <QMessageBox>
// Constructeur
Employe::Employe(int id, QString nom, QString prenom, QString role, double salaire)
    : id(id), nom(nom), prenom(prenom), role(role), salaire(salaire) {}
...
bool Employe::ajouter() {
    QSqlQuery query;
    query.prepare("INSERT INTO employe (id_e, nom, prenom, role, salaire) "
                  "VALUES (seq_employe.NEXTVAL, :nom, :prenom, :role, :salaire)");
...
bool Employe::modifier() {
    QSqlQuery query;
    query.prepare("UPDATE employe SET nom = :nom, prenom = :prenom, role = :role, salaire = :salaire "
                  "WHERE id_e = :id");
